 ...
 * detail. The terminal signal covers task.completed and terminal task.updated,
 * including Codex children that omit task.completed and Antigravity cancellation.
 */
