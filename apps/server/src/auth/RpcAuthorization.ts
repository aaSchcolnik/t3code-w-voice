...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.usageRead]: AuthOrchestrationReadScope,
  ...
  [WS_METHODS.computerUseGetStatus]: AuthOrchestrationReadScope,
  [WS_METHODS.computerUseTest]: AuthOrchestrationOperateScope,
  [WS_METHODS.knowledgeListProjects]: AuthOrchestrationReadScope,
  [WS_METHODS.knowledgeListSkills]: AuthOrchestrationReadScope,
  [WS_METHODS.knowledgeQuery]: AuthOrchestrationReadScope,
  [WS_METHODS.knowledgeScanAvailability]: AuthOrchestrationReadScope,
  [WS_METHODS.knowledgeUpsert]: AuthOrchestrationOperateScope,
  [WS_METHODS.knowledgeSetStatus]: AuthOrchestrationOperateScope,
  [WS_METHODS.knowledgeDeleteRow]: AuthOrchestrationOperateScope,
  [WS_METHODS.knowledgeGetProfile]: AuthOrchestrationReadScope,
  [WS_METHODS.knowledgeUpdateProfile]: AuthOrchestrationOperateScope,
  [WS_METHODS.knowledgeListCases]: AuthOrchestrationReadScope,
  [WS_METHODS.knowledgeListArtifacts]: AuthOrchestrationReadScope,
  [WS_METHODS.knowledgeGetArtifact]: AuthOrchestrationReadScope,
  [WS_METHODS.knowledgeDeleteCase]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.skillsSaveVersion]: AuthOrchestrationOperateScope,
  [WS_METHODS.skillsSetActiveVersion]: AuthOrchestrationOperateScope,
  [WS_METHODS.skillsUpdateMeta]: AuthOrchestrationOperateScope,
  [WS_METHODS.skillsDelete]: AuthOrchestrationOperateScope,
  [WS_METHODS.skillsRestoreDefaults]: AuthOrchestrationOperateScope,
  [WS_METHODS.skillsImportScan]: AuthOrchestrationReadScope,
  [WS_METHODS.skillsImport]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.terminalExecStart]: AuthTerminalOperateScope,
  [WS_METHODS.terminalExecAttach]: AuthTerminalOperateScope,
  [WS_METHODS.terminalExecCancel]: AuthTerminalOperateScope,
  [WS_METHODS.terminalExecReadOutput]: AuthTerminalOperateScope,
  ...
  [WS_METHODS.remotePreviewReleaseControl]: AuthPreviewControlScope,
  [WS_METHODS.remotePreviewClose]: AuthPreviewViewScope,
  [WS_METHODS.remotePreviewIssueViewerUrl]: AuthPreviewViewScope,
  [WS_METHODS.remotePreviewHostConnect]: AuthOrchestrationOperateScope,
  [WS_METHODS.remotePreviewHostSignal]: AuthOrchestrationOperateScope,
