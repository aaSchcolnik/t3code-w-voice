import {
  ...
  ProjectMcpSettingsUpdatedPayload as ContractsProjectMcpSettingsUpdatedPayloadSchema,
...
export const ProjectMcpSettingsUpdatedPayload = ContractsProjectMcpSettingsUpdatedPayloadSchema;
