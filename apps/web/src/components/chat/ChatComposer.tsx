...
export const ChatComposer = memo(function ChatComposer(props: ChatComposerProps) {
  ...
  const composerControls = noProviderAvailable ? (
    ...
    <>
      ...
      !composerControlsInStrip &&
      _isLocalDraftThread &&
      knowledgeScanAvailability !== null ? (
        <Tooltip>
          <TooltipTrigger
            render={
              <Button
  ...
  useImperativeHandle(
    ...
    () => ({
      ...
      addTerminalContext: (selection: TerminalContextSelection) => {
        if (!activeThread || isTerminalMode || isChoiceOnlyPendingQuestion) return;
        const snapshot = composerEditorRef.current?.readSnapshot() ?? {
          value: promptRef.current,
          cursor: composerCursor,
          expandedCursor: expandCollapsedComposerCursor(promptRef.current, composerCursor),
            ...
            >
              ...
              {isComposerCollapsedMobile || isComposerApprovalState ? null : (
                ...
                >
                  ...
                  >
                    {!isTerminalMode && showComposerAttachAction ? (
                      <>
                        <input
      ...
      <AlertDialog open={confirmLargeScan} onOpenChange={setConfirmLargeScan}>
        <AlertDialogPopup>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This repository contains {knowledgeScanAvailability?.sourceFileCount ?? 0} source
              files. The scan can consume substantial time and tokens.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
