...
import { TimelineTurnFoldToggle } from "./TimelineTurnFoldToggle";
import {
...
function UserTimelineRow({ row }: { row: Extract<TimelineRow, { kind: "message" }> }) {
  ...
  return (
    <div className="group flex flex-col items-end gap-1">
      ...
      <div className="flex w-full max-w-[80%] items-center justify-end pe-1 text-xs tabular-nums opacity-0 transition-opacity duration-200 focus-within:opacity-100 group-hover:opacity-100 any-pointer-coarse:opacity-100">
  ...
  return (
    <>
      <div className="relative min-w-0 px-1 py-0.5">
        ...
        />
        {row.showAssistantMeta ? (
          <div className="mt-1.5 flex items-center gap-2 text-xs tabular-nums opacity-0 transition-opacity duration-200 focus-within:opacity-100 group-hover/assistant:opacity-100 any-pointer-coarse:opacity-100">
