...
const WsComputerUseGetStatusRpc = Rpc.make(WS_METHODS.computerUseGetStatus, {
  payload: ComputerUseStatusInput,
  success: ComputerUseStatusResult,
  error: EnvironmentAuthorizationError,
});

const WsComputerUseTestRpc = Rpc.make(WS_METHODS.computerUseTest, {
...
const WsKnowledgeListProjectsRpc = Rpc.make(WS_METHODS.knowledgeListProjects, {
  payload: KnowledgeListProjectsInput,
  success: KnowledgeProjectList,
  error: knowledgeError,
});
const WsKnowledgeListSkillsRpc = Rpc.make(WS_METHODS.knowledgeListSkills, {
  payload: KnowledgeListSkillsInput,
  success: KnowledgeSkillsResult,
  error: knowledgeError,
});
const WsKnowledgeQueryRpc = Rpc.make(WS_METHODS.knowledgeQuery, {
  payload: KnowledgeQueryInput,
  success: KnowledgeRowsResult,
  error: knowledgeError,
});
const WsKnowledgeScanAvailabilityRpc = Rpc.make(WS_METHODS.knowledgeScanAvailability, {
  payload: KnowledgeScanAvailabilityInput,
  success: KnowledgeScanAvailabilityResult,
  error: knowledgeError,
});
const WsKnowledgeUpsertRpc = Rpc.make(WS_METHODS.knowledgeUpsert, {
  payload: KnowledgeUpsertInput,
  success: Schema.Array(Schema.Union([Schema.Number, Schema.String])),
  error: knowledgeError,
});
const WsKnowledgeSetStatusRpc = Rpc.make(WS_METHODS.knowledgeSetStatus, {
  payload: KnowledgeSetStatusInput,
  success: Schema.Number,
  error: knowledgeError,
});
const WsKnowledgeDeleteRowRpc = Rpc.make(WS_METHODS.knowledgeDeleteRow, {
  payload: KnowledgeDeleteRowInput,
  success: Schema.Boolean,
  error: knowledgeError,
});
const WsKnowledgeGetProfileRpc = Rpc.make(WS_METHODS.knowledgeGetProfile, {
  payload: KnowledgeProjectInput,
  success: KnowledgeProfileResult,
  error: knowledgeError,
});
const WsKnowledgeUpdateProfileRpc = Rpc.make(WS_METHODS.knowledgeUpdateProfile, {
  payload: KnowledgeUpdateProfileInput,
  success: Schema.Array(Schema.Union([Schema.Number, Schema.String])),
  error: knowledgeError,
});
const WsKnowledgeListCasesRpc = Rpc.make(WS_METHODS.knowledgeListCases, {
  payload: KnowledgeProjectInput,
  success: KnowledgeRecords,
  error: knowledgeError,
});
const WsKnowledgeListArtifactsRpc = Rpc.make(WS_METHODS.knowledgeListArtifacts, {
  payload: KnowledgeListArtifactsInput,
  success: KnowledgeRecords,
  error: knowledgeError,
});
const WsKnowledgeGetArtifactRpc = Rpc.make(WS_METHODS.knowledgeGetArtifact, {
  payload: KnowledgeGetArtifactRpcInput,
  success: KnowledgeProfileResult,
  error: knowledgeError,
});
const WsKnowledgeDeleteCaseRpc = Rpc.make(WS_METHODS.knowledgeDeleteCase, {
...
const WsSkillsSaveVersionRpc = Rpc.make(WS_METHODS.skillsSaveVersion, {
  payload: SkillSaveVersionInput,
  success: SkillVersionMutationResult,
  error: skillsError,
});
const WsSkillsSetActiveVersionRpc = Rpc.make(WS_METHODS.skillsSetActiveVersion, {
  payload: SkillSetActiveVersionInput,
  success: SkillDetail,
  error: skillsError,
});
const WsSkillsUpdateMetaRpc = Rpc.make(WS_METHODS.skillsUpdateMeta, {
...
const WsSkillsRestoreDefaultsRpc = Rpc.make(WS_METHODS.skillsRestoreDefaults, {
  payload: Schema.Struct({}),
  success: Schema.Array(SkillDetail),
  error: skillsError,
});
const WsSkillsImportScanRpc = Rpc.make(WS_METHODS.skillsImportScan, {
...
const WsTerminalExecStartRpc = Rpc.make(WS_METHODS.terminalExecStart, {
...
const WsTerminalExecAttachRpc = Rpc.make(WS_METHODS.terminalExecAttach, {
...
const WsTerminalExecCancelRpc = Rpc.make(WS_METHODS.terminalExecCancel, {
  payload: TerminalExecCancelInput,
  success: TerminalCommandRecord,
  error: Schema.Union([TerminalExecError, EnvironmentAuthorizationError]),
});

const WsTerminalExecReadOutputRpc = Rpc.make(WS_METHODS.terminalExecReadOutput, {
...
const WsRemotePreviewSignalRpc = Rpc.make(WS_METHODS.remotePreviewSignal, {
  payload: RemotePreviewSignalInput,
  error: Schema.Union([RemotePreviewError, EnvironmentAuthorizationError]),
});

const WsRemotePreviewRequestControlRpc = Rpc.make(WS_METHODS.remotePreviewRequestControl, {
  payload: RemotePreviewRequestControlInput,
  error: Schema.Union([RemotePreviewError, EnvironmentAuthorizationError]),
});

const WsRemotePreviewReleaseControlRpc = Rpc.make(WS_METHODS.remotePreviewReleaseControl, {
  payload: RemotePreviewReleaseControlInput,
  error: Schema.Union([RemotePreviewError, EnvironmentAuthorizationError]),
});

const WsRemotePreviewCloseRpc = Rpc.make(WS_METHODS.remotePreviewClose, {
  payload: RemotePreviewCloseInput,
  error: Schema.Union([RemotePreviewError, EnvironmentAuthorizationError]),
});

const WsRemotePreviewIssueViewerUrlRpc = Rpc.make(WS_METHODS.remotePreviewIssueViewerUrl, {
...
const WsRemotePreviewHostConnectRpc = Rpc.make(WS_METHODS.remotePreviewHostConnect, {
...
const WsRemotePreviewHostSignalRpc = Rpc.make(WS_METHODS.remotePreviewHostSignal, {
...
const WsSubscribeSubagentTranscriptRpc = Rpc.make(WS_METHODS.subscribeSubagentTranscript, {
...
const WsSubscribeSubagentRunsRpc = Rpc.make(WS_METHODS.subscribeSubagentRuns, {
...
const WsSubagentsCancelRunRpc = Rpc.make(WS_METHODS.subagentsCancelRun, {
...
const WsSubagentsRespondRpc = Rpc.make(WS_METHODS.subagentsRespond, {
  payload: SubagentRespondInput,
  success: SubagentControlResult,
  error: Schema.Union([SubagentRunError, DelegatedRunError, EnvironmentAuthorizationError]),
});

const WsSubagentsGetRunDetailsRpc = Rpc.make(WS_METHODS.subagentsGetRunDetails, {
  payload: SubagentRunDetailsInput,
  success: SubagentRunDetails,
  error: Schema.Union([SubagentRunError, EnvironmentAuthorizationError]),
});

const WsTranscriptionStartRpc = Rpc.make(WS_METHODS.transcriptionStart, {
...
const WsTranscriptionSendAudioRpc = Rpc.make(WS_METHODS.transcriptionSendAudio, {
  payload: TranscriptionAudioChunkInput,
  error: Schema.Union([TranscriptionError, EnvironmentAuthorizationError]),
});

const WsTranscriptionStopRpc = Rpc.make(WS_METHODS.transcriptionStop, {
...
const WsVoiceModelsGetStateRpc = Rpc.make(WS_METHODS.voiceModelsGetState, {
  payload: Schema.Struct({}),
...
const WsVoiceModelsPauseDownloadRpc = Rpc.make(WS_METHODS.voiceModelsPauseDownload, {
  payload: ServerVoiceModelTarget,
  success: ServerVoiceModelSnapshot,
  error: ServerVoiceModelRpcError,
});

const WsVoiceModelsCancelDownloadRpc = Rpc.make(WS_METHODS.voiceModelsCancelDownload, {
  payload: ServerVoiceModelTarget,
  success: ServerVoiceModelSnapshot,
  error: ServerVoiceModelRpcError,
});
...
const WsVoiceModelsSelectRpc = Rpc.make(WS_METHODS.voiceModelsSelect, {
  payload: ServerVoiceModelTarget,
  success: ServerVoiceModelSnapshot,
  error: ServerVoiceModelRpcError,
});

const WsSubscribeVoiceModelStateRpc = Rpc.make(WS_METHODS.subscribeVoiceModelState, {
  payload: Schema.Struct({}),
