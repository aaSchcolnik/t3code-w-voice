...
/**
 * Best-effort subscription quota reporting from provider accounts signed in on
 * the environment host. This is intentionally separate from transcript usage,
 * which reports tokens and estimated API-equivalent cost.
 */
