...
On an iPad, open the thread and choose **Browser** from the thread toolbar. T3 Code creates a
...
viewer waits for the host to return. If the desktop app could not capture the tab, close the tab and
