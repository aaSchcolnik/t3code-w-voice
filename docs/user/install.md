...
| Antigravity | [Antigravity CLI](https://antigravity.google/download) | `agy`          | Run `agy` once        |
| Grok Build  | [Grok Build CLI](https://x.ai/cli)                     | `grok`         | `grok login`          |
| OpenCode    | [OpenCode](https://opencode.ai)                        | `opencode`     | `opencode auth login` |

Codex and Claude are on by default. Cursor, Antigravity, Grok Build, and OpenCode are off by
